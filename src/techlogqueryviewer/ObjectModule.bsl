...
Функция ПолучитьПутьКЛогам() Экспорт
	Возврат КаталогПрограммы() + "conf\logs_techlogqueryviewer";
КонецФункции
...
Функция СоздатьФайлНастроек(Путь, ПолучатьПланыЗапросов = Истина) Экспорт
	...
	КонецЕсли;	
	ТекстДок.ДобавитьСтроку("<log location=""" + ПолучитьПутьКЛогам() + """ history=""1"">
	|<event>
...
// Разделители, которыми отделяются отдельные слова в запросе
//мРазделители = Новый Массив;
//мРазделители.Добавить(",");
//мРазделители.Добавить(".");
//мРазделители.Добавить("(");
//мРазделители.Добавить(")");
//мРазделители.Добавить(" ");
...
//мРазделители.Добавить("<");
//мРазделители.Добавить(">");
//мРазделители.Добавить(Символы.Таб);
//мРазделители.Добавить(Символы.ПС);

//мРазделители = Новый ТаблицаЗначений;
//мРазделители.Колонки.Добавить("Разделитель");
//мРазделители.Добавить().Разделитель = ",";
//мРазделители.Добавить().Разделитель = ".";
//мРазделители.Добавить().Разделитель = "(";
//мРазделители.Добавить().Разделитель = ")";
//мРазделители.Добавить().Разделитель = " ";
...
//мРазделители.Добавить().Разделитель = "<";
//мРазделители.Добавить().Разделитель = ">";
//мРазделители.Добавить().Разделитель = Символы.Таб;
//мРазделители.Добавить().Разделитель = Символы.ПС;
//мРазделители.Индексы.Добавить("Разделитель");
